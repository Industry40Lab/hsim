...
class Environment(Environment):
    ...
    def logF(self,entity,resource,operator,activity,time=True):
        ...
        self.log.loc[(log["timeOut"]==-1) & (self.log["resource"]==resource),"timeOut"]=time
        self.log.loc[len(self.log)] = [entity,resource,operator,activity,time,-1]
    
class Entity(object):
    def __init__(self,ID,pt={},route=None,Tin=None,Tout=None,ProductCode=None):
        self.ID = ID
        self.pt = pt
        self.route = route
        self.Tin = Tin
